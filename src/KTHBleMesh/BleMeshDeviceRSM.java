 ...
 */
public class BleMeshDeviceRSM extends BleMeshDevice {


	/**
	 * Constructs a {@code BleMeshDeviceRSM}. TODO Update this auto-generated
	 * comment!
	 *
	 * @param aParent
	 * @param aName
	 */
	public BleMeshDeviceRSM() {
		super();
		this.ComputeInitalRSM();
	}

	private int initRSMValue;
	private int currESMValue;
